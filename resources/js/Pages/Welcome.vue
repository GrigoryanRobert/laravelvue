...
<template>
    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
            <Link
                :href="route('todolist')"
                class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-4 focus:rounded-sm focus:outline-red-500"
            >To do list</Link>
            <Link
